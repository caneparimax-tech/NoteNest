...
<body>
 ...
 <ul>
    ...
    <li><a href="enrollment.php" class="enrollment"><i class="material-icons">group_add</i> Enrollment</a></li>
    <li><a href="logout.php" class="logout"><i class="material-icons">logout</i> Logout</a></li>
  </ul>
