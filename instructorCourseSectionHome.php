...
<body>
    ...
    <div class="topbar">
    <a href="instructorUserHompage.php" class="breadcrumb-link">Home </a><span class="arrow">></span>
...
<ul>
    ...
    <div id="sortStatusContainer">
        ...
        <h2>Course Notes</h2>
        <button class="roster" onclick="location.href='instructorRoster.php?sectionID=<?php echo htmlspecialchars($sectionID); 
?>&courseName=<?php echo htmlspecialchars($courseName); ?>'">Roster</button>
    </div>
