<?php 
    ...
    try {
        $stmt = $dbconnect->prepare("SELECT UC.UserID, UC.Email, S.StudentID, S.FName, S.LName FROM UserCredentials UC INNER JOIN Students S ON UC.UserID = S.UserID WHERE UC.Email = :email");
        $stmt->bindParam(':email', $email);
        $stmt->execute();
        $student = $stmt->fetch(PDO::FETCH_ASSOC);

        // If student user exists, display profile information
        if ($student) {
...
?>
            ...
            <div class="sidenav">
                ...
                <hr>
                <a href="studentUserHomepage.php" class="home"><i class="material-icons">home</i></i> Home</a>
                <a href="studentProfile.php" class="profile"><i class="material-icons">account_circle</i></i> Profile</a>
            ...
            <script>
                document.getElementById('delete-account-btn').addEventListener('click', function() {
                    ...
                    if (confirmation) {
                        fetch("studentDeleteAccount.php", {
                            method: "POST",
                            headers: {
