<?php 
    ...
    //check if user is logged in and is an Instructor, if not redirect to login page
    ...
    try {
        $stmt = $dbconnect->prepare("SELECT UC.UserID, UC.Email, I.InstructorID, I.FName, I.LName FROM UserCredentials UC INNER JOIN Instructors I ON UC.UserID = I.UserID WHERE UC.Email = :email");
        $stmt->bindParam(':email', $email);
        $stmt->execute();
        $instructor = $stmt->fetch(PDO::FETCH_ASSOC);

        // If instructor user exists, display profile information
        if ($instructor) {
...
?>
            ...
            <div class="sidenav">
                ...
                <a href="#" class="enrollment"><i class="material-icons">group_add</i></i> Enrollment</a>
            ...
            <script>
                document.getElementById('delete-account-btn').addEventListener('click', function() {
                    ...
                    if (confirmation) {
                        fetch("instructorDeleteAccount.php", {
                            method: "POST",
                            headers: {
            ...
            <?php
                ...
                echo "Instructor user not found.";
            }
